...
public class ArrayDeque<T> implements DequeInterface<T> {
	...
	public void addToBack(T newEntry) { // same as com.company.ArrayQueue enqueue
		ensureCapacity();
	...
	public T getFront() { // same as com.company.ArrayQueue
		if (isEmpty()) {
	...
	public T removeFront() { // same as com.company.ArrayQueue dequeue
		if (isEmpty()) {
			throw new EmptyQueueException();
		}
		else {
	...
	public void clear() {  // same as com.company.ArrayQueue dequeue
		if (!isEmpty()) {
	...
	private void ensureCapacity() {  // same as com.company.ArrayQueue dequeue
