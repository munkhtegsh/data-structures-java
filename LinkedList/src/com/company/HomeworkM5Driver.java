...
//        Node<Integer> firstNode = new Node<Integer>(Integer.valueOf(3), new Node<Integer>(Integer.valueOf(8), new Node<Integer>(Integer.valueOf(6), new Node<Integer>(Integer.valueOf(12)))));
        ...
        numberBag.add(2);
        numberBag.add(3);
        numberBag.duplicateContents();
        System.out.println(Arrays.toString(numberBag.toArray()));
...
//        System.out.println("TEST =============");
    ...
    public static boolean isDoublyLinkedPalindromeList(DoubleNode<Integer> firstNode, DoubleNode<Integer> lastNode) {
        ...
        DoubleNode<Integer> head = firstNode;
        DoubleNode<Integer> tail = lastNode;
        DoubleNode<Integer> currentNode = firstNode;
        int entries = 0;
        int midPoint;
        ...
        double div = entries / 2.0;
        midPoint =  (int) Math.ceil(div);
